...
class DashboardScreens extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       ...
       appBar: AppBar(title: const Text('Schedule Provider'), backgroundColor: Colors.brown, centerTitle: true),
       body: Padding(
          ...
          child: Column(
             children: [
                if(aiService.currentAnalysis !=null)
                   ...
                   ElevatedButton(
                      onPressed: aiService.isLoading ? null : () => aiService.analyzeSchedule(scheduleProvider
                      .tasks), child: aiService.isLoading ? const CircularProgressIndicator() : const Text('Resolved Conflicts With'),
                   ),
                   ],
          ),
          ),
